...
import com.library.base.util.QMUIDisplayHelper;
import com.library.base.util.QMUILangHelper;
import com.library.base.util.QMUILog;
import com.library.base.util.QMUIResHelper;
...
public class QMUIBottomSheet extends Dialog {
    ...
    public static class BottomListSheetBuilder {
        ...
        /**
         *
         * @param textAndTag  Item 数据集合
         * @return
         */
        public BottomListSheetBuilder addItem(List<String> textAndTag) {
            for (int i = 0; i < textAndTag.size(); i++) {
                mItems.add(new BottomSheetListItemData(textAndTag.get(i), textAndTag.get(i)));
            }
            return this;
        }
        ...
        private View buildViews() {
            ...
            image_close = (ImageView) wrapperView.findViewById(R.id.image_close);
            button = (Button) wrapperView.findViewById(R.id.button);
            ...
            button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(mContext , "dianlewo " , Toast.LENGTH_SHORT).show();
                }
            });
