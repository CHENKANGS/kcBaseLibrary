...
//    private static HiPermission mInstance;
    ...
    public void checkMutiPermission(PermissionCallback callback) {
        checkMutiPermission(callback, true);
    }
     ...
     * @param callback
     */
    public void checkMutiPermission(PermissionCallback callback, boolean isShowUi) {
    ...
    private void startActivity() {
        ...
        intent.putExtra(ConstantValue.DATA_IS_SHOW_UI, mIsShowUi);
